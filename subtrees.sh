...
${cmd} modes/flycheck https://github.com/flycheck/flycheck.git master
...
${cmd} modes/helm-projectile https://github.com/bbatsov/helm-projectile v0.14.0
...
${cmd} modes/avy-menu https://github.com/mrkkrp/avy-menu 0.
${cmd} modes/avy https://github.com/abo-abo/avy 0.4.0
